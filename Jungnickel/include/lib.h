...
// utils_edges.c
Edge		*create_edge			(int id, int from, int to, int cost);					// ok
int 		len_edge_list			(Edge *head);								// ok, scattered functions
void		add_directed_edge		(Vertex **vs, int from, int to, int edge_id, int cost);	// edge_id?
void		add_undirected_edge		(Vertex **vs, int from, int to, int edge_id, int cost);	// edge_id?
